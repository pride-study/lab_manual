...
When conducting analyses, store raw data files only on the approved secure storage system, specify the secure file path in your integrated development environment, and access and analyze data from the secure location without creating local copies. Refer to @sec-file-paths for suggested R workflows implementing these practices.
