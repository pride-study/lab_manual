...
In general, we recommend using descriptive folder and file names, *e.g.*, `R/` or `scripts/` to organize source code and `output` or `reports` to organize research outputs. You should also include guidance on the organization of your project in a `README` file (see @sec-readme for more details about `README` files).
